...
class SentimentRecommenderModel:
    ...
    """function to get the top product 20 recommendations """
    ...
    """function to classify the sentiment to  positive or negative """
    ...
    def preprocess_text(self, text):
        ...
        # removing stop-words and converting it to lemma
